...
public class ProcedimientosNegocioDAO {

    public void calcularBalanceMensual(
            int idUsuario,
            int idPresupuesto,
            short anio,
            short mes) {
        ...
        try (
            ...
            try (ResultSet rs = cs.executeQuery()) {
                if (rs.next()) {
                    ...
                    System.out.println(
                            "Total ahorros: "
                                    + rs.getBigDecimal("total_ahorros")
                    );
                    System.out.println(
                            "Balance final: "
                                    + rs.getBigDecimal("balance_final")
                    );
                } else {
                    System.out.println(
                            "No se encontro informacion para ese periodo."
                    );
                }
            }
            ...
            System.out.println(
                    "Error al calcular el balance mensual: "
                            + e.getMessage()
            );
        }
    }

    public void calcularMontoEjecutadoMes(
            int idSubcategoria,
            int idPresupuesto,
            short anio,
            short mes) {
    ...
    public void calcularPorcentajeEjecucionMes(
            int idSubcategoria,
            int idPresupuesto,
            short anio,
            short mes) {
        ...
        try (
            ...
            System.out.println(
                    "Error al calcular el porcentaje: "
                            + e.getMessage()
            );
        }
    }

    public void obtenerResumenCategoriaMes(
            int idCategoria,
            int idPresupuesto,
            short anio,
            short mes) {
        ...
        try (
            ...
            System.out.println(
                    "Error al obtener el resumen de categoria: "
                            + e.getMessage()
            );
        }
    }

    public void procesarObligacionesMes(
            int idUsuario,
            short anio,
            short mes,
            int idPresupuesto) {
        ...
        String sql =
                "{ call sp_procesar_obligaciones_mes("
                        + "?, ?, ?, ?) }";
        ...
        try (
            ...
            try (ResultSet rs = cs.executeQuery()) {
                ...
                while (rs.next()) {
                    ...
                    System.out.println(
                            "Alerta: "
                                    + rs.getString("p_alerta")
                    );
                }

                if (!encontro) {
                    System.out.println(
                            "No hay obligaciones activas para ese periodo."
                    );
                }
            }
            ...
            System.out.println(
                    "Error al procesar las obligaciones: "
                            + e.getMessage()
            );
        }
    }
    ...
    public void registrarTransaccionCompleta(
            int idUsuario,
            int idPresupuesto,
            short anio,
            short mes,
        ...
        try (
            ...
            System.out.println(
                    "Error al registrar la transaccion completa: "
                            + e.getMessage()
            );
        }
    }
